# Kuruma-Logger サポートサイト仕様書（ドラフト v0.3）
...
- 原稿は `website/content/` 配下（Markdown）で管理
- PR ベースでレビューして公開
- 更新情報は `/updates/` で明示
...
1. Phase 1: 土台構築
   ...
   - 共通レイアウト/ナビ実装
2. Phase 2: 最小コンテンツ公開
   - ホーム/セットアップ/FAQ/問い合わせ
3. Phase 3: 運用強化
   - トラブルシュート拡充
   - 更新情報ページ運用
   - 問い合わせフォーム改善（迷惑送信対策など）
