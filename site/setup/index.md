...
- インストール手順
  ...
  - 下記のボタンから[公式インストーラサイト][7]にアクセスします。
  - 書き込みツールより、Google アカウントでログインします。
  - サイトの誘導に従ってインストールします。
...
<div class="cta-row">
  <a class="cta-button primary" href="https://app.kuruma-logger.com/flash/">書き込みツールを開く →</a>
</div>

書き込みが完了したらこのページに戻り、続きの手順（中間ハーネスの取り付け）へ進んでください。

[7]: https://app.kuruma-logger.com/flash/
