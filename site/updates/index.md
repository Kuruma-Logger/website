...
- 再インストール手順: [WEB インストーラを開く](https://app.kuruma-logger.com/portal/) → ログイン → デバイス選択 → USB 接続 → 書き込み
...
| --- | --- | --- | --- |
| Roadster ND | v1.0.13 (beta) | v1.0.13 (beta) | 配信中 |
| Civic FL5 | v1.0.13 (beta) | v1.0.13 (beta) | 配信中 |
