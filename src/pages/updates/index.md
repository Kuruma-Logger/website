...
## 配信ステータス（2026-03-07時点）

| 車種 | 新規インストール | 更新インストール | ステータス |
|---|---|---|---|
| Roadster ND | v0.2.3 | v0.2.3 | 配信中 |
| Civic FL5 | v0.2.3 | v0.2.3 | 配信中 |
...
| v0.2.2 | 2026-03-07 | Shift-upインジケータの閾値を車種ごとに設定可能化し、FL5/NDで表示色とビープ条件を最適化。 |
| v0.2.1 | 2026-03-07 | FL5のブレーキ表示値を補正。Shift-upインジケータの閾値/配色を調整し、FL5のShift-upビープに対応。 |
| v0.2.0 | 2026-03-07 | Live Monitor導入、GUI統合とFL5表示改善、Shift-up表示/ビープ応答性改善、前回画面の復元対応。 |
